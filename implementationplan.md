...
*   **Why React Native (Expo) over Alternatives (like Flutter/Kotlin/Swift)?**
    *   Since our Desktop (Tauri) and Browser Extensions rely on Web Technologies (React), using React Native allows us to write our **Cryptography, State Management, and Sync Logic exactly once** in pure TypeScript and share it across *all 5 platforms*.
...
*   **Encryption Flow:**
    ...
    4.  `DEK` is *also* encrypted with an Argon2id derivative of `RecoveryKey`.
