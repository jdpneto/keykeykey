...
- **Password Export** — Export credentials to a standard CSV for portability *(planned)*
- **Password Generator** — Cryptographically secure random passwords and passphrases with entropy estimation *(planned)*
- **TOTP Authenticator** — Built-in 2FA code generation (RFC 6238), replacing apps like Authy or Google Authenticator *(planned)*
- **Autofill** — System-level autofill on iOS/Android and browser extension form filling *(planned)*
