...
- **Playwright E2E currently `continue-on-error: true`** — Once flaky tests are stabilized, flip to blocking. Easy config change once the underlying tests are reliable.
